...
for rate in (1.5, 2, 2.5):
    ...
    torch.testing.assert_close(project(identity, p, lut, 2), w, rtol=0, atol=0)
...
for k, n in ((6144, 512), (512, 6144), (6144, 2048), (2048, 6144)):
    ...
    for m in (1, 4, 16, 64):
        ...
        def complete(splits):
            if args.fused:
                return project(x, p, lut, splits, rows, sv, input_scales=su)
            ext.had_r_128(x, xh, su, None, 1.0)
            return project(xh, p, lut, splits, rows, sv)
